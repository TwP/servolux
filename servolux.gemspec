...
Gem::Specification.new do |s|
  ...
  s.authors = ["Tim Pease"]
  s.date = %q{2009-06-18}
  s.description = %q{Threads : Servers : Forks : Daemons}
  s.email = %q{tim.pease@gmail.com}
  s.extra_rdoc_files = ["History.txt", "README.rdoc"]
  s.files = ["History.txt", "README.rdoc", "Rakefile", "lib/servolux.rb", "lib/servolux/daemon.rb", "lib/servolux/piper.rb", "lib/servolux/server.rb", "lib/servolux/threaded.rb", "spec/servolux_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
  ...
  s.summary = %q{Threads : Servers : Forks : Daemons}
